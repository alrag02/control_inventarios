                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="justify-content-end pb-2">
                                <a @cannot('crear usuarios') hidden @endcan href="{{url('/usuarios/registrados/create')}}" class="btn btn-black">Nuevo Usuario</a>
                            </div>
                            <table id="table-datatable" class="table table-striped">
                                <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Apellidos</th>
