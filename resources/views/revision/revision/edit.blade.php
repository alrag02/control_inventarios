                ...
                <div class="card-wrapper_articulo">
                    <div class="">
                        <div class="form-row">
                            ...
                            <div class="col-lg-7">
                                <h1>{{ __('Lista de '.$nombre_concepto.'s de la revision') }}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-striped" onload="document.getElementsByClassName('table-toggle').style.display = 'none';">
                            ...
                            @foreach($articulo as $data)
                                <tr class="showed" onload="toggle_by_class('hidden_{{$data->id}}', true);">
                                    ...
                                    <td>
                                        <button class="btn btn-outline-dark" id="button_mostrar" onClick="toggle_by_class('hidden_{{$data->id}}', true); document.getElementById('button_ocultar').hidden = false; this.hidden = true;">▼</button>
                                        <button class="btn btn-outline-dark" id="button_ocultar" onClick="toggle_by_class('hidden_{{$data->id}}', false); document.getElementById('button_mostrar').hidden = false; this.hidden = true;" hidden>▲</button>
                                    </td>
                                </tr>
