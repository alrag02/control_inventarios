            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('inmobiliario.'.$nombre_concepto.'.update',$departamento->id)}}" method="POST"
                                  onsubmit="
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nombre" id="inv_camp_nombre" value="{{$departamento->nombre}}" placeholder="Inserte el nombre aquí" required max="100">
                                </div>
                                <!-- fk_area -->
                                <div class="form-group">
