                                                ...
                                                <h4 class="card-title">Información General</h4>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <select name="familia" class="form-select" id="inv_camp_familia">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="form-select" name="estado" id="inv_camp_estado">
                                                                <option selected disabled class="font-italic">Seleccione...</option>
                                                ...
                                                <h4 class="card-title">Datos de Adquisición</h4>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-8">
                                                            ...
                                                            <input type="text" class="form-control" id="inv_camp_num_factura" placeholder="#xxxxxxx">
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <!-- fk_tipo_compra -->
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="activo_resguardo" id="inv_camp_activo" value="1" checked>
                                                                <label class="form-check-label" for="inv_camp_activo">Activo</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="activo_resguardo" id="inv_camp_resguardo" value="2">
                                                                <label class="form-check-label" for="inv_camp_resguardo">Resguardo</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="activo_resguardo" id="inv_camp_nd" value="0">
