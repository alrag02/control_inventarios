            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('inmobiliario.'.$nombre_concepto.'.update',$area->id)}}" method="POST" onsubmit="
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nombre" id="inv_camp_nombre" value="{{$area->nombre}}" placeholder="Nombre" required max="100">
                                </div>
                                <!-- vigencia -->
