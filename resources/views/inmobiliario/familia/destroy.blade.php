            ...
            <div class="modal-content">
                @if(count($familia->articulo) > 0)
                    ...
                    <div class="modal-body">
                        <p>{{'Tiene '.count($familia->articulo).' artículos dependientes, edítelos para que no dependan de esta familia y evitar errores'}}</p>
                    </div>
                ...
                @elseif(count($familia->foto) > 0)
                    ...
                    <div class="modal-body">
                        <p>{{'Tiene '.count($familia->foto).' fotos dependientes, edítelos para que no dependan de esta familia y evitar errores'}}</p>
                    </div>
                    <div class="modal-footer">
