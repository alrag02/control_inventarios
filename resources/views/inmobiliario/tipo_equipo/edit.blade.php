            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('inmobiliario.'.$nombre_concepto.'.update',$tipo_equipo->id)}}" method="POST" onsubmit="
                            ...
                            document.getElementById('btn_destroy').hidden = true;  ">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nombre" id="inv_camp_nombre" value="{{$tipo_equipo->nombre}}" placeholder="Nombre" required max="100">
                                </div>
                                <!-- sigla -->
                                <div class="form-group">
                                    <input type="text" class="form-control" name="sigla" id="inv_camp_sigla" value="{{$tipo_equipo->sigla}}" placeholder="Sigla" required max="100">
                                </div>
                                <!-- vigencia -->
                                <div class="form-group" @cannot('baja conceptos') hidden @endcan>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vigencia" id="inv_camp_vigencia_baja" value="0" {{($tipo_equipo->vigencia == 0) ? 'checked':''}}>
