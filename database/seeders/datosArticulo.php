...
class datosArticulo extends Seeder
{
    ...
    public function run()
    {
        Articulo::create( [
            'id'=>1,
            'etiqueta_local'=>'ITSLM-19-CI-EO-2448',
            ...
            'empleado_encargado_area'=>1,
            'empleado_titular'=>2,
            'empleado_titular_secundario'=>3,
            'empleado_resguardo'=>2,
            'empleado_resguardo_secundario'=>3,
            'fk_familia'=>1,
            'fk_departamento'=>2,
            'fk_estado'=>1,
            'fk_foto'=>2,
        ...
        Articulo::create( [
            'id'=>2,
            'etiqueta_local'=>'ITSLM-19-CI-EO-6221',
            ...
            'disponibilidad'=>'sin_revisar',
            'disponibilidad_updated_at'=>NULL,
            'empleado_encargado_area'=>2,
            'empleado_titular'=>1,
            'empleado_titular_secundario'=>NULL,
            'empleado_resguardo'=>3,
            'empleado_resguardo_secundario'=>NULL,
            'fk_familia'=>2,
            'fk_departamento'=>3,
            'fk_estado'=>1,
            'fk_foto'=>4,
        ...
        Articulo::create( [
            'id'=>3,
            'etiqueta_local'=>'ITSLM-09-CI-EC-3596',
        ...
        Articulo::create( [
            'id'=>4,
            'etiqueta_local'=>'ITSLM-20-CI-EO-3048',
            ...
            'cantidad'=>17,
            'placas'=>NULL,
            'observaciones'=>'Tiene una tuerca rara',
        ...
        Articulo::create( [
            'id'=>5,
            'etiqueta_local'=>'ITSLM-20-CI-EO-3918',
            'etiqueta_externa'=>'tecmm-WWWWWW-yyyyy',
            'concepto'=>'Escritorio Blanco',
            'marca'=>'Tiger',
            'modelo'=>'MX-32412',
            'descripcion'=>'Escritorio Blanco para oficina',
            'numero_serie'=>'8J8H8Y',
            'color'=>'blanco',
            'cantidad'=>20,
            'placas'=>NULL,
        ...
        Articulo::create( [
            'id'=>6,
            'etiqueta_local'=>'ITSLM-10-CI-EO-2429',
            'etiqueta_externa'=>'tecmm-yyyy-yyyyy',
            'concepto'=>'Carpeta verde para oficina',
            'marca'=>'Lefort',
            'modelo'=>'Carta',
            'descripcion'=>NULL,
            'numero_serie'=>'92e092',
